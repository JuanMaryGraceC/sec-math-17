...
\section{Substitution Rule}\label{substitution-rule}}
...
\(\frac{-4}{-4}\). Thus, \$\$ \int (1-4x)\^{}\frac{1}{2}dx =
\int (1-4x)\^{}\frac{1}{2}\cdot \frac{-4}{-4}dx =
\int (u)\^{}\frac{1}{2} (-\frac{du} \{4\}) = -\frac{1}{4}
\int (u)\^{}\frac{1}{2}du = -/frac\{1\}\{4\}
