...
1.  $\displaystyle\lim_{x \to 0} \frac{x^2-3x}{2x^2+x}$ $\left(\frac{0}{0}\right)$ **Solution**. $$
...
2.  $\displaystyle\lim_{x \to 0} \frac{\sin5x}{\sin3x}$ $\left(\frac{0}{0}\right)$ **Solution**. $$
...
4.  $\displaystyle\lim_{x \to +\infty}\frac{3x-1}{7-6x}$ $\left(\frac{+\infty}{-\infty}\right)$ **Solution**. $$
...
::: {#exm:remarks}
**Example** Evaluate the following limits. 1. $\displaystyle\lim_{x \to 0} \frac{x^2-3x}{2x^2+x}$ $\frac{0}{0}$ **Solution**. $$
...
5.  $\displaystyle\lim_{x \to 1} \frac{x^3-3x+2}{1-x+\ln x}$ $\left(\frac{0}{0}\right)$ **Solution**. $$
    \begin{aligned}
...
6.  $\displaystyle\lim_{x \to 0^-}\frac{\csc x}{1-\cot x}$ $\left(\frac{-\infty}{+\infty}\right)$ **Solution**. $$
    \begin{aligned}
...
::: {#exm:5.6.6}
**Solution** Note that since $x+\sin x \ge x - 1$ for any $x \in R$ and $\displaystyle\lim_{x \to +\infty} {x-1=+\infty}$, then $\displaystyle\lim_{x \to +\infty}{x + \sin x = +\infty}$ as well. Thus, the limit is indeterminate of type $\left(\frac{\infty}{\infty}\right)$.
...
2.  $\displaystyle\lim_{x\to a}{\frac{f(x)}{\frac{1}{g(x)}}}$, which is indeterminate of type $\frac{0}{0}$, or

3.  $\displaystyle\lim_{x\to a}{\frac{g(x)}{\frac{1}{f(x)}}}$, which is indeterminate of type $\frac{\infty}{\infty}$ and apply L'Hospital's Rule

4.  If $\displaystyle\lim_{x\to a}{f(x)+g(x)}$ is indeterminate of type $\infty - \infty$, rewrite $f(x)+g(x)$ as a single expression to obtain an indeterminate form of type $\frac{0}{0}$ or $\frac{\infty}{\infty}$ and apply L'Hospital's Rule.
:::

::: {#exm:example}
**Example** Evaluate the following limits.

1.  $\displaystyle\lim_{x\to 0^+}{\sin^{-1} (2x) \csc x}$ $(0\cdot +\infty)$ **Solution**
...
\end{aligned}
$$ 2. $\displaystyle\lim_{0\to \frac{\pi}{2}^-}{\tan \theta \ln (\sin \theta)}$ $+\infty \cdot 0$ **Solution**
...
\end{aligned}
$$ 3. $\displaystyle\lim_{x\to 1^+}{\left(\frac{x}{x-1}-\frac{1}{\ln x}\right)}$ $\left(\frac{1}{0^+}-\frac{1}{0^+}\right)$ **Solution**
...
1.  $\displaystyle\lim_{x\to 0^+}{x^{\sin x}}$ $0^0$ **Solution**
...
2.  $\displaystyle\lim_{x\to +\infty}{\left(1-\frac{3}{x}\right)^{2x}}$ $1^\infty$ **Solution**
